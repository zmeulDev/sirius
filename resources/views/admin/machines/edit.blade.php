    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.machines.update", [$machine->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mch_name') ? 'is-invalid' : '' }}" type="text" name="mch_name" id="mch_name" value="{{ old('mch_name', $machine->mch_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mch_ip') ? 'is-invalid' : '' }}" type="text" name="mch_ip" id="mch_ip" value="{{ old('mch_ip', $machine->mch_ip) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('mch_type') ? 'is-invalid' : '' }}" name="mch_type" id="mch_type" required>
                    ...
                    @foreach(App\Models\Machine::MCH_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('mch_type', $machine->mch_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('mch_sql') ? 'is-invalid' : '' }}" name="mch_sql" id="mch_sql">
                    ...
                    @foreach(App\Models\Machine::MCH_SQL_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('mch_sql', $machine->mch_sql) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('mch_win') ? 'is-invalid' : '' }}" name="mch_win" id="mch_win">
                    ...
                    @foreach(App\Models\Machine::MCH_WIN_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('mch_win', $machine->mch_win) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('system_settings') ? 'is-invalid' : '' }}" type="text" name="system_settings" id="system_settings" value="{{ old('system_settings', $machine->system_settings) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sql_settings') ? 'is-invalid' : '' }}" type="text" name="sql_settings" id="sql_settings" value="{{ old('sql_settings', $machine->sql_settings) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_settings') ? 'is-invalid' : '' }}" type="text" name="other_settings" id="other_settings" value="{{ old('other_settings', $machine->other_settings) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('checklist') ? 'is-invalid' : '' }}" name="checklist_id" id="checklist_id" required>
                    @foreach($checklists as $id => $entry)
                        <option value="{{ $id }}" {{ (old('checklist_id') ? old('checklist_id') : $machine->checklist->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
