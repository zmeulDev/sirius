    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.maintenances.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stlr_caseid') ? 'is-invalid' : '' }}" type="number" name="stlr_caseid" id="stlr_caseid" value="{{ old('stlr_caseid', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stlr_machineid') ? 'is-invalid' : '' }}" type="text" name="stlr_machineid" id="stlr_machineid" value="{{ old('stlr_machineid', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stlr_machine') ? 'is-invalid' : '' }}" type="text" name="stlr_machine" id="stlr_machine" value="{{ old('stlr_machine', '') }}">
