    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-farmDatacenterFarms">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <tr data-entry-id="{{ $farm->id }}">
                                ...
                                <td>
                                    @foreach($farm->farm_datacenters as $key => $item)
                                        <span class="badge badge-info">{{ $item->datacenter }}</span>
                                    @endforeach
                                </td>
                                <td>
                                    @can('farm_show')
...
@endcan
  ...
  let table = $('.datatable-farmDatacenterFarms:not(.ajaxTable)').DataTable({ buttons: dtButtons })
