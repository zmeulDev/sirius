                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search">
                                ...
                                @foreach($datacenters as $key => $item)
                                    <option value="{{ $item->datacenter_name }}">{{ $item->datacenter_name }}</option>
                                @endforeach
                            </select>
                        </td>
                        <td>
                        ...
                        <td>
                            <select class="search">
                                <option value>{{ trans('global.all') }}</option>
                                @foreach($backup_trackers as $key => $item)
                                    <option value="{{ $item->bck_tracker_name }}">{{ $item->bck_tracker_name }}</option>
                                @endforeach
                            </select>
                        </td>
                        <td>
                            <select class="search">
                                <option value>{{ trans('global.all') }}</option>
                                @foreach($backup_clusters as $key => $item)
                                    <option value="{{ $item->bck_clus_name }}">{{ $item->bck_clus_name }}</option>
                                @endforeach
                            </select>
                        </td>
                        <td>
