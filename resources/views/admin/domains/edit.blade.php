    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.domains.update", [$domain->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('domain_name') ? 'is-invalid' : '' }}" type="text" name="domain_name" id="domain_name" value="{{ old('domain_name', $domain->domain_name) }}" required>
